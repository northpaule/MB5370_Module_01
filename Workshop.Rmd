...
```{r, Task: Environmental Stress Classification}
library(dplyr)
...
```
```{r, Calculating Square Roots of Site Vectors}
...
```{r, kniting for blogging}
#library(knitr, markdown)
knit("Workshop.Rmd") # produces a .md file (use name of your markdown file)
#markdown::html_format("Workshop.md", "workshop.html", fragment.only=TRUE) # produces clean .html
